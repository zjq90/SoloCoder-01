...
exports.transformFor = (0, transform_1.createStructuralDirectiveTransform)('for', (node, dir, context) => {
    ...
    return processFor(node, dir, context, (forNode) => {
        ...
        return () => {
            ...
            if (memo) {
                const loop = (0, compiler_core_1.createFunctionExpression)(createForLoopParams(forNode.parseResult, [
                    (0, compiler_core_1.createSimpleExpression)(`_cached`),
                ]));
                ...
                renderExp.arguments.push((0, compiler_core_1.createFunctionExpression)(createForLoopParams(forNode.parseResult, [
                    (0, compiler_core_1.createSimpleExpression)(`_`),
                ]), childBlock, true /* force newline */));
            }
        };
    });
});
